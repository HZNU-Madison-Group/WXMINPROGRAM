...
Page({
   ...
   */
  data: {
    message: [{ "id": 59, "problem": "123789789789789789789789789789789789123", userid: "49", createtime: "2019-10-23", parentid: "1" }, { "id": 2, "problem": "123123", userid: "49", createtime: "2019-10-23", parentid: "1" }],
    all:null
  },
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://172.22.130.33/index.php/Ajaxapi/Ajaxapi/browsereplybyid/pid/'+app.globalData.id,
    ...
    wx.request({
      ...
      success: function (res) {
        console.log(res);
        that.setData({ //======不能直接写this.setDate======
          all: res.data.data, //在相应的wxml页面显示接收到的数据
        });
      }
    })
  },
